...
//  Atributos
  ...
  public ContaBancariaComConstrutor(String nome, int num, int ag, float lim) {
      this.nome = nome;
      this.numero = num;
      this.agencia = ag;
      this.saldo = 0;
  ...
  public ContaBancariaComConstrutor(String nome, int num, int ag, float saldo, float lim) {
      this.nome = nome;
      this.numero = num;
      this.agencia = ag;
      this.saldo = saldo;
...
//      ContaBancariaComConstrutor conta1 = new ContaBancariaComConstrutor();
